...
class pdbS_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'participants-database-search'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'participants-database-search'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'participants-database-search'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'participants-database-search'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'participants-database-search');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'participants-database-search'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'participants-database-search');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'participants-database-search'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'participants-database-search') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'participants-database-search');
            case 'false':
                return __('false', 'participants-database-search');

            case 'Administrator':
                return __('Administrator', 'participants-database-search');
            case 'Editor':
                return __('Editor', 'participants-database-search');
            case 'Author':
                return __('Author', 'participants-database-search');
            case 'Contributor':
                return __('Contributor', 'participants-database-search');
            case 'Subscriber':
                return __('Subscriber', 'participants-database-search');
            case 'Anyone':
                return __('Anyone', 'participants-database-search');
        }
        return $optionValue;
    }
